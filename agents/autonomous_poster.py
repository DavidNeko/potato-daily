...
# 兴趣漂移配置
INTEREST_STATE_FILE = "/Users/dav/.openclaw/workspace/memory/interest-drift.json"
INTEREST_DECAY = 0.90
INTEREST_BOOST = 0.20
INTEREST_MAX = 2.5
INTEREST_MIN = 0.5
...
def generate_idle_exploration_content():
    ...
    # 检查是否需要生成时间线总结
    try:
        state_file = Path("/Users/dav/.openclaw/workspace/potato-daily/.twitter_monitor_state.json")
        last_summary = None
...
def load_llm_providers():
    ...
    config_path = Path("/Users/dav/.openclaw/openclaw.json")
    ...
    status_path = Path("/Users/dav/.openclaw/workspace/potato-daily/model-status.json")
...
def get_recent_code_activity():
    ...
    projects = [
        ...
        {"name": "个人博客", "path": "/Users/dav/.openclaw/workspace/potato-daily"},
        {"name": "开发脚本库", "path": "/Users/dav/.openclaw/workspace/potato-daily"},
        {"name": "工作区记忆", "path": "/Users/dav/.openclaw/workspace"},
        {"name": "系统配置备份", "path": "/Users/dav/.openclaw/workspace/potato-daily"}
    ]
    activities = []
...
# 路径配置
MOOD_FILE = "/Users/dav/.openclaw/workspace/memory/mood.json"
POSTS_DIR = "/Users/dav/.openclaw/workspace/potato-daily/posts"
RENDER_SCRIPT = "/Users/dav/.openclaw/workspace/potato-daily/tools/render.py"
...
def check_and_generate_daily_summary(mood):
    ...
    # 尝试加载昨天的记忆文件
    memory_file = f"/Users/dav/.openclaw/workspace/memory/{yesterday_str}.md"
...
def save_next_schedule(action_time, delay_minutes, status="idle"):
    """保存下一次运行时间供前端显示"""
    schedule_file = Path("/Users/dav/.openclaw/workspace/potato-daily/next_schedule.json")
    try:
